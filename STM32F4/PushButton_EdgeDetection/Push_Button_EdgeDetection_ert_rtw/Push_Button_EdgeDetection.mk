###########################################################################
## Makefile generated for Simulink model 'Push_Button_EdgeDetection'. 
## 
## Makefile     : Push_Button_EdgeDetection.mk
## Generated on : Sun May 14 15:38:54 2017
## MATLAB Coder version: 3.0 (R2015b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Push_Button_EdgeDetection.elf
...
PRODUCT_NAME              = Push_Button_EdgeDetection
MAKEFILE                  = Push_Button_EdgeDetection.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/ronak/Documents/GitHub/MATLAB_MODEL_BASED_DESIGN/STM32F4/PushButton_EdgeDetection
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Push_Button_EdgeDetection_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Push_Button_EdgeDetection.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR)/Push_Button_EdgeDetection_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/dsp/include -I$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include/src -I$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include -I$(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/serial -IC:/MATLAB/SupportPackages/R2015b/armcortexm/toolbox/target/supportpackages/arm_cortex_m/scheduler/include -IC:/MATLAB/SupportPackages/R2015b/STM32F4-master/STM32F4-Discovery_FW_V1.1.0/Libraries/CMSIS/ST/STM32F4xx/Include -IC:/MATLAB/SupportPackages/CMSIS_r4p3/CMSIS/Include -IC:/MATLAB/SupportPackages/R2015b/STM32F4-master/STM32F4-Discovery_FW_V1.1.0/Project/Peripheral_Examples/SysTick -IC:/MATLAB/SupportPackages/R2015b/STM32F4-master/STM32F4-Discovery_FW_V1.1.0/Libraries/STM32F4xx_StdPeriph_Driver/inc -IC:/MATLAB/SupportPackages/R2015b/stmicroelectronicsstm32f4discovery/toolbox/target/supportpackages/stm32f4discovery/@slCustomizer/../include -IC:/MATLAB/SupportPackages/R2015b/armcortexm/toolbox/target/supportpackages/arm_cortex_m/cmsis_rtos_rtx/include -IC:/MATLAB/SupportPackages/CMSIS_r4p3/CMSIS/RTOS/RTX/INC -IC:/MATLAB/SupportPackages/CMSIS_r4p3/CMSIS/RTOS/RTX/SRC
...
DEFINES_ = -DMODEL=Push_Button_EdgeDetection -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DUSE_STDPERIPH_DRIVER -DUSE_STM32F4_DISCOVERY -DSTM32F4XX -DARM_MATH_CM4=1 -D__FPU_PRESENT=1 -D__FPU_USED=1 -DHSE_VALUE=8000000 -DNULL=0 -D__START=_start -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DOS_ROBIN=0 -DOS_TIMERS=1 -DOS_TIMERPRIO=6 -DOS_TIMERSTKSZ=200 -DRT -DSTACK_SIZE=64
...
DEFINES_STANDARD = -DMODEL=Push_Button_EdgeDetection -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
OBJS = Push_Button_EdgeDetection.o Push_Button_EdgeDetection_data.o stm32f4xx_gpio.o stm32f4xx_rcc.o stm32f4xx_gpio_wrapper.o blapp_support.o startup_stm32f4xx.o syscalls_stm32f4xx.o stm32f4xx_init_board.o system_stm32f4xx.o SysTickScheduler.o arm_cortex_m_multitasking.o
...
%.o : $(START_DIR)/Push_Button_EdgeDetection_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Push_Button_EdgeDetection_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Push_Button_EdgeDetection_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Push_Button_EdgeDetection_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Push_Button_EdgeDetection_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
